        ...
        ">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                    ...
                    <!-- Date Of Birth -->
                    <div class="col-md-12 margin-input" style="margin-bottom: 0px; height: 5px">
                        <div style="text-align: left; margin-left: 0px;  font-size: 16px;">
                            Date of Birth:
                        </div>
                    </div>
                    <div class="col-md-12 margin-input">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        togglePasswordButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                button.querySelector('svg').classList.toggle('bi-eye-slash');
            });
        });
    });
</script>
